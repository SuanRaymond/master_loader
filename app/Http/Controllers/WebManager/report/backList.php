...
use App\Presenter\Manager\backList_presenter;

use App\Services\web_judge_services;
use App\Services\connection_services;
use App\Services\Manager\ctrl_services;

class backList extends Controller
{
	public $box;
	...
	public function index()
    {
    	...
    	$box = $this->box;
        return mMView('report.backList', compact('box'));
    }
    ...
    public function search()
    {
        ...
        //放入連線區塊
        //需呼叫的功能
        $this->box->callFunction = 'GetBackList';
        ...
        $backList_presenter    = new backList_presenter();
        ...
        $html = $backList_presenter->combination($this->box->result);
        //購物清單 主體資訊 HTML組成
