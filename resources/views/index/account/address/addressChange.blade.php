    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#SendBtn").click(function(){
                RaySys.Alert.Fixet("{{ trans('message.onWaiting') }}", "{{ trans('message.onChangeing') }}", 0);
            });
        });
    </script>
@stop
...
@section('content')
    <div class="panel panel-primary" style="font-size: 130%;">
        <div class="panel-heading">
            <h2 class="panel-title" align="center" style="font-size: 110%;">{{ trans('view.addressList.changeTitle') }}</h2>
        </div>
        <div class="panel-body">
            <form>
                <input type="hidden" name="addressID" value="{{ $box->params->addressID }}">
