...
use App\Presenter\Manager\tradeList_presenter;
...
class tradeList extends Controller
{
	...
	public function index()
    {
    	...
    	$box = $this->box;
        return mMView('report.tradeList', compact('box'));
    }
    ...
    public function search()
    {
        ...
        //放入連線區塊
        //需呼叫的功能
        $this->box->callFunction = 'GetTradeList';
        ...
        $tradeList_presenter    = new tradeList_presenter();
        ...
        $html = $tradeList_presenter->combination($this->box->result);
        //購物清單 主體資訊 HTML組成
