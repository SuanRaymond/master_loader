...
@section('content')
    ...
    <div>
        ...
        <div class="span12">
            <table class=" table table-striped table-bordered table-condensed">
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: right;vertical-align: middle;">
                            {{ trans('view.MFile.th.information') }}
                        </td>
                        <td>
                            <table class="table" style="margin: 0px;">
                                <tbody>
                                    <tr>
                                        <td style="vertical-align: middle;">{{ trans('view.MFile.th.accountName') }}</td>
                                        <td style="vertical-align: middle;">{{ $box->member->bankname }}</td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">{!! trans('view.MFile.th.bankCode') !!}</td>
                                        <td style="vertical-align: middle;">{{ trans('view.MFile.cl.Bank'.$box->member->bankID) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: middle;">{!! trans('view.MFile.th.cardnumber') !!}</td>
                                        <td style="vertical-align: middle;">{{ $box->member->cardID }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
        ...
        <div class="span6">
            <a href="/CMFile" class="button button-flat-primary button-large  button-block">{{ trans('view.MFile.b.CMFile') }}</a>
            <br><br>
        </div>
        <div class="span6">
            <a href="
