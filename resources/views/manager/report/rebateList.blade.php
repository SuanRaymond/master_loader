	...
	@if(isset($box->result->body))
	    <div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-cogs"></i>{{ trans('managerView.rebateList.t.title') }}</div>
				<div class="tools">
			...
			<div class="portlet-body no-more-tables">
				@if($box->result->body != '')
					...
					<table class="table table-striped table-bordered table-hover table-full-width cf" id="searchDataTable">
						<thead class="cf">
							<tr class="tableRowB">
								<th style="text-align: center;">{{ trans('managerView.rebateList.th.rebateID') }}</th>
								...
								<th style="text-align: center;" class="numeric">{{ trans('managerView.rebateList.th.moneyBack') }}</th>
								<th style="text-align: center;" class="numeric">{{ trans('managerView.rebateList.th.back') }}</th>
								<th style="text-align: center;" class="numeric">{{ trans('managerView.rebateList.th.baseOdds') }}</th>
